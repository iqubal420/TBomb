...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing SARKAR'
    else
        figlet SARKAR
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mIqubal Sarkar \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border SARKAR
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Facebook: facebook.com/sarkar.saheb420 \e[0m"
    echo -e "\e[4;32m   Github: https://github.com/iqubal420 \e[0m"
    echo -e "\e[4;32m   Fb Group: TRS TEAM \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By SARKAR> .update
